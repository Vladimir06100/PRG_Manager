         ...
         @endif
            ...
            @csrf
              <div class="form-group">
                ...
                <!-- Error -->
                @error('pseudo')<div class="invalid-feedback">{{ $errorMessage }}</div>@enderror
              </div>
              <div class="form-group">
                <label for="nom">Votre Nom</label>
                <input type="text" name="nom" id="nom" class="form-control @error('nom') is-invalid @enderror" value="{{ old('nom') }}" size="20">
                <!-- Error -->
                @error('nom')<div class="invalid-feedback">{{ $errorMessage }}</div>@enderror
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <!-- Error -->
                @error('email')<div class="invalid-feedback">{{ $errorMessage }}</div>@enderror
              </div>
              <div class="form-group">
                ...
                <!-- Error -->
               @error('password')<div class="invalid-feedback">{{ $errorMessage }}</div>@enderror
              </div>
              <div class="form-group">
